...
import { X, Minus, Plus, Loader2, MessageCircle } from "lucide-react";
...
const TeamPricingDialog: React.FC<TeamPricingDialogProps> = ({
  ...
  const handleContinue = async () => {
    ...
    if (subscription === "pro" || subscription === "pro-plus" || subscription === "ultra") {
                  ...
                  <div className="flex flex-col gap-4 text-center">
                    ...
                    {subscription !== "free" && (
                      <div className="text-sm text-muted-foreground bg-muted/50 rounded-lg px-4 py-2">
                        Your remaining subscription time will be credited
                        toward Team
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex flex-col gap-6">
                    <div className="flex w-full flex-col">
                      ...
                      <Input
                        ...
                        className="h-12 w-full rounded-full border border-border px-5 text-sm focus:border-foreground focus:ring-foreground"
                      />
                    </div>
                      ...
                      <div className="flex flex-col gap-6 rounded-3xl border border-border p-5">
                        ...
                        <div className="flex grow flex-col text-sm">
                          <div className="text-muted-foreground flex w-full justify-between text-sm">
                            <div className="flex">Umbraa Team</div>
                ...
                <div className="flex w-full max-w-[400px] flex-col items-center md:max-w-[600px]">
                  ...
                  <div className="mb-6 flex w-full flex-col">
                    ...
                    <div className="mt-1 text-muted-foreground text-xs">
                      We'll use this to create your private workspace.
                    </div>
                  </div>
